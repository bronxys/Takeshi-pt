    ...
    const handleMessage = async (node) => {
        ...
        try {
            ...
            await messageMutex.mutex(async () => {
                ...
                // Surface the raw stanza's `decrypt-fail` attribute (and enc type) onto the
                // upserted message so the bot can detect "hidden" undecryptable group messages.
                // Upstream only sets decrypt-fail=hide for reactions/pinInChat, so a hidden or
                // undecryptable group message is a strong signal of the sender-key-withholding
                // trick used to deliver invisible payment messages. See src/utils/stealthPayment.js.
                try {
